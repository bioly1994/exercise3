...
@WebServiceClient(name = "HumanResourceService", 
                  wsdlLocation = "file:/c:/users/bioly/Desktop/hr_pliki/hr.wsdl",
...
public class HumanResourceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/c:/users/bioly/Desktop/hr_pliki/hr.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HumanResourceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/c:/users/bioly/Desktop/hr_pliki/hr.wsdl");
        }
        WSDL_LOCATION = url;
    }
